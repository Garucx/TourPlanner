...
COPY public.tour_logs (tour_id, date_time, tour_comment, difficulty, total_time, rating) FROM stdin;
1	2022-06-09 18:29:27.255581	asdasd	3	4	4
\.
...
COPY public.tours (id, name, description, tour_from, transport_type, distance, "time", route_information) FROM stdin;
1	Test1	Some Desc 1	Test	Test	10	10	https:test
2	Test1	Some Desc 1	Test	Test	10	10	https:test
3	Test1	Some Desc 1	Test	Test	10	10	https:test
4	Test1	Some Desc 1	Test	Test	10	10	https:test
\.
...
SELECT pg_catalog.setval('public.tours_id_seq', 4, true);
